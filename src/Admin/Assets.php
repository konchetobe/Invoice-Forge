    ...
    private function getLocalizedData(): array
    {
        return [
            ...
            'i18n'      => [
                ...
                'confirmDeleteInvoice' => __('Are you sure you want to delete this invoice?', 'invoiceforge'),
                'confirmDeleteClient'  => __('Are you sure you want to delete this client?', 'invoiceforge'),
                'saving'               => __('Saving...', 'invoiceforge'),
                'saved'                => __('Saved!', 'invoiceforge'),
                'saveError'            => __('Failed to save. Please try again.', 'invoiceforge'),
                'networkError'         => __('Network error. Please try again.', 'invoiceforge'),
                'validationError'      => __('Please fill in all required fields.', 'invoiceforge'),
                ...
                'dueDateWarning'       => __('Due date cannot be before invoice date.', 'invoiceforge'),
                'clientRequired'       => __('Please select a client.', 'invoiceforge'),
                'invoiceTitleRequired' => __('Invoice title is required.', 'invoiceforge'),
                'loading'              => __('Loading...', 'invoiceforge'),
                'confirmEmail'         => __('Are you sure you want to send this invoice to the client via email?', 'invoiceforge'),
                'emailSent'            => __('Email sent successfully.', 'invoiceforge'),
                'emailFailed'          => __('Failed to send email.', 'invoiceforge'),
                'resetCounterConfirm'  => __('Are you sure you want to reset the invoice counter? This cannot be undone.', 'invoiceforge'),
                'counterValueInvalid'  => __('Please enter a valid counter value (minimum 1).', 'invoiceforge'),
                'counterResetFailed'   => __('Failed to reset counter.', 'invoiceforge'),
                'counterSetFailed'     => __('Failed to set counter.', 'invoiceforge'),
                'clientName'           => __('Client Name', 'invoiceforge'),
                'updating'             => __('Updating...', 'invoiceforge'),
                'upToDate'             => __('Up to date', 'invoiceforge'),
                'previewUnavailable'   => __('Preview unavailable', 'invoiceforge'),
                'remove'               => __('Remove', 'invoiceforge'),
                'fieldLabel'           => __('Field label', 'invoiceforge'),
                'left'                 => __('Left', 'invoiceforge'),
                'right'                => __('Right', 'invoiceforge'),
            ],
            'settings'  => [
